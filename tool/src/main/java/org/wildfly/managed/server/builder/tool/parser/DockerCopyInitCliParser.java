 ...
 */
public class DockerCopyInitCliParser extends NodeParser {
    private static final String ROOT_ELEMENT_NAME = "assembly";
    private final Path inputFile;
    private ElementNode root;

    public DockerCopyInitCliParser(Path inputFile) {
